...
export function Ipad({
  ...
  return (
    <div className="ipad-frame">
      <div className={cn("ipad-screen", dark && "theme-dark")}>
        <div className="ipad-camera" />
        <div className="pointer-events-none absolute inset-x-0 top-0 z-40 flex h-[42px] items-end px-6 pb-[6px]">
          <span className="w-[84px] text-[13px] font-semibold tracking-tight text-ink">{time}</span>
          <div className="flex flex-1 items-center justify-center">
            <span className="rounded-full bg-ink/8 px-3 py-[3px] font-mono text-[10px] text-ink-soft">
              iPad Pro · 12.9"
            </span>
          </div>
          <div className="flex w-[84px] justify-end gap-1.5 text-ink">
            <Signal />
            <Wifi />
            <Battery />
          </div>
